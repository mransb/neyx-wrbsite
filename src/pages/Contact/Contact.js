    ...
    <Container>
      <Row className="mt-5">
        ...
        <Col lg={5}>
          <h2>Contact Us</h2>
          <p>
            We are always very happy to answer you. Any questions or any doubts
            or if you just want to say Hi, please get in touch with us by
            leaving a message here. Our team will get back to you as soon as
            ­possible.
          </p>
          <Row>
            <Col lg={6}>
